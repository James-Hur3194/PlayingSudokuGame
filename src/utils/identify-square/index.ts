...
/**
 * A function that identifies and returns the current square of a given sudoku at a row and column index.
 * @param param0 input Object with 9X9 Sudoku Grid, row index and column index 
 * @returns 
 */
